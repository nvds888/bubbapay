    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-6">
            BubbaPay utilizes Algorand's atomic group transactions to ensure that <strong>fund creators always retain the ability 
            to reclaim their funds</strong> if they are not claimed by recipients. This provides a safety mechanism, but users 
            must actively monitor and manage their transactions.
          </p>
        ...
        <section className="border-t border-gray-200 pt-8">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p className="text-blue-700">
              ...
              irreversible, but BubbaPay's smart contract system allows senders to reclaim unclaimed funds as a safety measure.
            </p>
          </div>
        </section>
      </div>
